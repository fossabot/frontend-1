...
Блок предоставляет разметку контактной информации.
...
| --------| --------------------- | -------- |
| <a href=#phone>phone</a> | <code>BEMJSON</code> | Номер телефона |
| <a href=#email>email</a> | <code>BEMJSON</code> | Адрес электронной почты |
<!--
